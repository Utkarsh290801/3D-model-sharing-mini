                    ...
                    {({ values, handleSubmit, handleChange }) => (
                      <form onSubmit={handleSubmit}>
                        <fieldset>
                          ...
                          <TextField label="Title" id="title" value={values.title} onChange={handleChange} className="w-100 mb-4" />
                          <TextField
                            label="Description"
                            id="description"
                          ...
                          />
                          <TextField label="Size" id="size" value={values.size} onChange={handleChange} className="w-100 mb-4" />
                          <TextField
                            label="Triangle"
                            id="triangle"
                          ...
                          <TextField
                            ...
                            className="w-100 mb-4"
                          />
                          <TextField label="Support" id="support" value={values.support} onChange={handleChange} className="w-100 mb-4" />

                            <label>Uploade Image</label>
                            <input className="form-control" onChange={uploadImage} />
